...
abstract class UserInfoRepository {
  ...
  Future<dynamic> deleteForeignAccount(
      {required DeleteForeignAccount? account});
  ...
  Future<dynamic> getRelatedBusinessToEdit(
      {required String? RequestId, required int? RelatedBusinessId});
  ...
  Future<dynamic> getNextOfKinToEdit(
      {required String? RequestId, required int? NextOfKinId});
  ...
  Future<dynamic> getRefereeToEdit(
      {required String? RequestId, required int? RefereeId});
  ...
  Future<dynamic> getChildToEdit(
      {required String? RequestId, required int? ChildId});
  ...
  Future<dynamic> getStakeHolderToEdit(
      {required String? RequestId, required int? StakeHolderId});
  ...
  Future<dynamic> getDocumentAttachedToEdit(
      {required String? RequestId, required int? DocumentsAttachedId});
  Future<dynamic> deleteDocumentAttached(
      {required DeleteDocument? deleteDocument});

  Future<dynamic> getAssignedAccountToEdit(
      {required String? RequestId, required int? AssignedAcctId});
  Future<dynamic> editAssignedAccount({required AssignedAccountToEditData? data});
  Future<dynamic> addAssignedAccount({required GenerateAssignedAccount? data});
  ...
  Future getOtherBankAccountToEdit(
      {required String? RequestId, required int? OtherAccountsId});
  ...
  Future<dynamic> deleteOtherBankAccount(
      {required DeleteOtherBankAccount? data});
