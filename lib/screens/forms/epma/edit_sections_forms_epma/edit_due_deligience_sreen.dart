...
class EditDueDilligienceScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EditDueDilligienceScreen> createState() =>
      _EditDueDilligienceScreenState();
}

class _EditDueDilligienceScreenState
    extends ConsumerState<EditDueDilligienceScreen> {
    ...
    return ZxploreProgress(
      ...
      child: BaseEditForm(
          ...
          button: Padding(
            ...
            child: PrimaryButton(
                onPressed: () {
                  if (selectedFatcaStatusItem == null) {
                    return;
                  }
                  ;
          ...
          widgetToGoOnCancel: ViewDueDilligience(
            formIndividualData:
                      ...
                      return ref.watch(getFatcaStatusProvider).when(
                            data: (data) => (data != null &&
                                ...
                                ? DropdownButtonHideUnderline(
                                    child: DropdownButton2<FatcaStatusDatum>(
                                      isExpanded: true,
                                      hint: Text(
                                        'Select status',
                                        style: TextStyle(
                                      ...
                                      onChanged: (FatcaStatusDatum? newValue) {
                                        setState(() {
                                ...
                                : TextButton(
                                    onPressed: () =>
                                        ref.invalidate(getFatcaStatusProvider),
