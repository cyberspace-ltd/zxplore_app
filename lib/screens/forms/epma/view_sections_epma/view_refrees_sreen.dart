...
class ViewRefreesScreen extends ConsumerStatefulWidget {
  ...
  const ViewRefreesScreen(
      {Key? key, required this.formIndividualData})
      : super(key: key);

  @override
  ConsumerState<ViewRefreesScreen> createState() =>
      _ViewRefreesScreenState();
}

class _ViewRefreesScreenState
    extends ConsumerState<ViewRefreesScreen> {
  @override
