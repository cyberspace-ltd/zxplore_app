...
class AddNextOfKinScreen extends ConsumerStatefulWidget {
  const AddNextOfKinScreen({super.key,this.data});
 final GetNextOfKinToEditResponse? data;

  @override
  ConsumerState<AddNextOfKinScreen> createState() => _AddNextOfKinScreenState();
}

class _AddNextOfKinScreenState extends ConsumerState<AddNextOfKinScreen> {
  ...
  Future<void> _submitForm(BuildContext context)async {
    ...
    ref.read(editNextOfKinControllerProvider.notifier).addNok(context:context, data: account);
  ...
  Widget build(BuildContext context) {
    ...
    return ZxploreProgress(
      ...
      child: BaseAddForm(
        ...
        widgetToGoOnSave: ViewNextOfKinScreen(formIndividualData: ref.read(activelyViewedRequestProvider)!.toMap(),),
        onCancel: (){},
        data: {}, 
