...
class AddNextOfKinScreen extends ConsumerStatefulWidget {
  const AddNextOfKinScreen({super.key, this.requestId});
...
class _AddNextOfKinScreenState extends ConsumerState<AddNextOfKinScreen> {
  ...
  Future<void> _submitForm(BuildContext context) async {
    ...
    ref
        ...
        .addNok(context: context, data: account);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ZxploreProgress(
      ...
      child: BaseAddForm(
        ...
        widgetToGoOnSave: ViewNextOfKinScreen(
          ...
          child: PrimaryButton(
              onPressed: () {
                ...
                if (selectedGenderItem == null) {
                  zXFlushBar(context, "Gender required");
                }
                _submitForm(context);
              },
              title: 'Save'),
