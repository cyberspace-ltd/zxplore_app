...
class AddAssignedAccout extends ConsumerStatefulWidget {
  const AddAssignedAccout({super.key, this.data});
  final GetAssignedAccountToEditResponse? data;

  @override
  ConsumerState<AddAssignedAccout> createState() => _AddAssignedAccoutState();
}

class _AddAssignedAccoutState extends ConsumerState<AddAssignedAccout> {
