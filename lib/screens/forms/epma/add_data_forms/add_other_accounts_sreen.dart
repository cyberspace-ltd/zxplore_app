...
class AddOtherBankAccountScreen extends ConsumerStatefulWidget {
  const AddOtherBankAccountScreen({super.key, this.requestId});
  final String? requestId;

  @override
  ConsumerState<AddOtherBankAccountScreen> createState() =>
      _AddOtherBankAccountScreenState();
}

class _AddOtherBankAccountScreenState
    extends ConsumerState<AddOtherBankAccountScreen> {
  ...
  Future<void> _submitForm(BuildContext context) async {
    final userData = widget.requestId;
    ...
    ref
        ...
        .addOtherBankAccount(context: context, data: account);
  }
