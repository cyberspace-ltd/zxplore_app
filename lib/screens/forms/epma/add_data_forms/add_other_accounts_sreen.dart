...
class AddOtherBankAccountScreen extends ConsumerStatefulWidget {
  const AddOtherBankAccountScreen({super.key,this.data});
  final GetOtherBankAccountToEditResponse? data;

  @override
  ConsumerState<AddOtherBankAccountScreen> createState() => _AddOtherBankAccountScreenState();
}

class _AddOtherBankAccountScreenState extends ConsumerState<AddOtherBankAccountScreen> {
  ...
  Future<void> _submitForm(BuildContext context)async {
    ...
    ref.read(editOtherBankControllerProvider.notifier).addOtherBankAccount(context:context, data: account);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ZxploreProgress(
      ...
      child: BaseAddForm(
        ...
        widgetToGoOnSave: ViewOtherAccounts(requestData: ref.read(activelyViewedRequestProvider)!.toMap(),),
        onCancel: (){},
        data: {}, 
