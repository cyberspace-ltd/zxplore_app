...
part 'edit_other_bank_controller.g.dart';

@riverpod
class EditOtherBankController extends _$EditOtherBankController {
  @override
  ...
  Future<dynamic> deleteOtherBankAccountData(BuildContext context,
      {required String? RequestId, required DeleteOtherBankAccount? delData}) async {
    final repo = ref.read(userInfoRepositoryImplProvider);
