...
part of 'edit_assigned_account_controller.dart';
...
String _$editAssignedAccountControllerHash() =>
    r'616b2a2fe0a974ced27d49e3d038065bef6448dd';

/// See also [EditAssignedAccountController].
@ProviderFor(EditAssignedAccountController)
final editAssignedAccountControllerProvider = AutoDisposeAsyncNotifierProvider<
    EditAssignedAccountController, dynamic>.internal(
  EditAssignedAccountController.new,
  name: r'editAssignedAccountControllerProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$editAssignedAccountControllerHash,
  dependencies: null,
