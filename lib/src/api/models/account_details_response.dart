...
class AccountDetailsData {
  ...
  factory AccountDetailsData.fromJson(Map<String, dynamic> json) =>
      AccountDetailsData(
        ...
        signatoryDetails: List<AccountDetailsSignatoryDetail>.from(
  ...
  Map<String, dynamic> toJson() => {
        ...
        "SignatoryDetails":
            List<dynamic>.from(signatoryDetails!.map((x) => x.toJson())),
        "Ref_Id": refId,
...
class AccountDetailsSignatoryDetail {
  ...
  factory AccountDetailsSignatoryDetail.fromJson(Map<String, dynamic> json) =>
      AccountDetailsSignatoryDetail(
        ...
        attachments: List<AccountDetailsAttachment>.from(json["Attachments"]
...
class AccountType {
  ...
  AccountType({this.description, this.classType});
}
