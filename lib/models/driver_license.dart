...
class DriverLicenseResponse {
  ...
  factory DriverLicenseResponse.fromJson(Map<String, dynamic> json) =>
      DriverLicenseResponse(
        ...
        processingCenter:
            json["ProcessingCenter"] == null ? null : json["ProcessingCenter"],
        classOfLicence:
            json["ClassOfLicence"] == null ? null : json["ClassOfLicence"],
        nationality: json["Nationality"] == null ? null : json["Nationality"],
        dateOfIssue: json["DateOfIssue"] == null ? null : json["DateOfIssue"],
        expiryDate: json["ExpiryDate"] == null ? null : json["ExpiryDate"],
        certificateDate:
            json["CertificateDate"] == null ? null : json["CertificateDate"],
        certificateOfCompetence: json["CertificateOfCompetence"] == null
            ? null
            : json["CertificateOfCompetence"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "CertificateOfCompetence":
            certificateOfCompetence == null ? null : certificateOfCompetence,
