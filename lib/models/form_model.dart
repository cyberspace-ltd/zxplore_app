...
AccountForm accountFormFromJson(String str) => AccountForm.fromJson(json.decode(str));
...
class AccountForm {
  ...
  factory AccountForm.fromJson(Map<String, dynamic> json) => new AccountForm(
    ...
    signatoryDetails: new List<SignatoryDetail>.from(json["SignatoryDetails"].map((x) => SignatoryDetail.fromJson(x))),
    refId: json["Ref_Id"],
...
class SignatoryDetail {
  ...
  factory SignatoryDetail.fromJson(Map<String, dynamic> json) => new SignatoryDetail(
    ...
    attachments: new List<Attachment>.from(json["Attachments"].map((x) => Attachment.fromJson(x))),
  );
